    ...
    <div class="py-8 max-w-6xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-2">
                <button onclick="ExportUtils.exportToPDF('roles-table', 'roles')" 
                        class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded text-sm font-medium">
                    📄 PDF
                </button>
                <button onclick="ExportUtils.exportToExcel('roles-table', 'roles')" 
        ...
        <div class="overflow-x-auto mt-4">
            <table id="roles-table" class="min-w-full bg-gray-800 rounded shadow">
                <thead>
                ...
                <tbody>
                    @foreach($roles as $rol)
                        <tr class="border-b border-gray-700 hover:bg-gray-900 text-white">
