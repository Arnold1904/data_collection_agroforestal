<x-sidebar-layout>
    ...
    <div class="py-8 flex justify-center">
        <form action="{{ route('users.store') }}" method="POST" class="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded shadow">
            @csrf
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Nombre</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Contraseña</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Confirmar Contraseña</label>
