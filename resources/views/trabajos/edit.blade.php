<x-sidebar-layout>
    ...
    <div class="py-8 flex justify-center">
        <form action="{{ route('trabajos.update', $trabajo) }}" method="POST" class="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded shadow">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Actor</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Categoría</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Rol</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Influencia</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Relcamclim</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Vinagro</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Observaciones</label>
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('trabajos.index') }}" class="ml-2 text-gray-600 hover:text-gray-900">Cancelar</a>
            </div>
        </form>
    </div>
</x-sidebar-layout>
